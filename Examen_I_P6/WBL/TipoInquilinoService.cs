    ...
    public class TipoInquilinoService : ITipoInquilinoService
    {
...

        {
            ...
            try
            {
                ...
                var result = sql.QueryAsync<TipoInquilinoEntity>(sp: "dbo.Lista_TI");
...

        {
            ...
            try
            {
                ...
                var result = sql.QueryFirstAsync<TipoInquilinoEntity>(sp: "dbo.Obtener_TI", Param: new
                {
...

        {
            ...
            try
            {
                ...
                var result = sql.ExecuteAsync(sp: "dbo.Insertar_TI", Param: new
                {
                    entity.Descripcion,
                    entity.Estado
...

        {
            ...
            try
            {
                ...
                var result = sql.ExecuteAsync(sp: "dbo.Editar_TI", Param: new
                {
                    entity.Id_TipoInquilino,
                    entity.Descripcion,
                    entity.Estado
...

        {
            ...
            try
            {
                ...
                var result = sql.ExecuteAsync(sp: "dbo.Eliminar_TI", Param: new
                {
                    entity.Id_TipoInquilino
                });
